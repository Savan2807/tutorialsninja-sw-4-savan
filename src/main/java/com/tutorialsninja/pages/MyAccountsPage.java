...
public class MyAccountsPage extends Utility {
    ...
    public void enterPhoneNumber() {
        sendTextToElement(mobileNumber, "07999555999");
    }

    public void enterPassword() {
        sendTextToElement(password, "Savan2807");
    }

    public void enterConfirmPassword() {
        sendTextToElement(confirmPassword, "Savan2807");
    }
    ...
    public void enterEmail() {
        sendTextToElement(emailId, "savankakadiya1005@gmaol.com");
    }
